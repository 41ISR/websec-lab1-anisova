1.1 Доменное имя
Доменное имя сайта — tkv.dev/, также используются поддомены:

`shop.example.com` — для интернет-магазина,
`blog.example.com` — для новостного блога.

1.2 IP-адрес
Основной IP-адрес сайта — 92.124.140.111, зарегистрирован в Russian.

1.3 Время создания домена
Домен example.com был зарегистрирован .
